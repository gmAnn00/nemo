      ...
      <div class="sc2_contents">
        ...
        <div class="sc2_subsection">
          ...
          <div class="myProfile">
            ...
            <div class="myProMo">
              <h3>내정보 조회</h3>
              <a href="${contextPath}/mypage/modProfile" role="button" class="button">수정</a>
            </div>

            <!--4-2-->
            <div class="myIM">
              <div class="myImage">                
                <form id="userIMGform" action="${contextPath}/mypage/userImgUpload" method="post" enctype="multipart/form-data">
                <c:choose>
                ...
                <c:when test="${!empty userVO}">                                  
                  ...
                  <label class="imageM button" for="hidden" id="file">수정
                  </label>
                  <input id="hidden" type="file" style="display: none" name ="user_img" onchange="readImage(this)"/>
                </form>
              </div>
            </div>
