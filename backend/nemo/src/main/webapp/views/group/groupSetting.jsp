            ...
            <div class="sc2_contents">
                ...
                <div class="sc2_subsection">
                    ...
                    <div class="sc2_subcontents">
                        <div class="sc2_subcontents_title">
                            <div>
                                <span class="sc2_subcontents_name">소모임 프로필 사진</span>
                            </div>
                            <div>
                                <form action="">
                                    <label for="file">
                                    ...
                                    <input type="file" id="file" name="file" class="inputBox" />
                                </form>
                            </div>
                        </div>
                        <div>
                            <img src="../../images/sc1_title.jpeg" alt="title" class="sc2_img" />
                        </div>
                    </div>
                    <div class="sc2_subcontents">
                        <div class="sc2_subcontents_title">
                            <div><span class="sc2_subcontents_name">소개글</span></div>
                            <div><i class="fa-solid fa-pen"></i></div>
                        </div>
                        <div>
                            <textarea class="sc2_textarea" name="" id="" cols="30" rows="10" placeholder="내용을 입력해 주세요."></textarea>
                        </div>
                    </div>
                    <div class="sc2_subcontents">
                        <div class="sc2_subcontents_title">
                            <div><span class="sc2_subcontents_name">지역</span></div>
                            <div><i class="fa-solid fa-pen"></i></div>
                        </div>
                        <div>
                            <iframe
                            ...
                            ></iframe>
                            <div class="sc2_address">서울특별시 종로구 미려빌딩6층</div>
                        </div>
                    </div>
                    <div class="sc2_subcontents">
                        <div class="sc2_subcontents_title">
                            <div><span class="sc2_subcontents_name">카테고리</span></div>
                            <div><i class="fa-solid fa-pen"></i></div>
                        </div>
                        <div class="sc2_category">
                            <div class="category_box">sports</div>
                            <div class="category_box">game</div>
                        </div>
                    </div>
                    <div class="sc2_subcontents_btn">
                        <button class="button sc2_button">적용</button>
                        <button class="buttonCancle sc2_button">취소</button>
                    </div>
                </div>
                <!-- 컨텐츠 종료 -->
            </div>
