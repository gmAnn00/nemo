...
<link rel="stylesheet" href="${contextPath}/css/modInterest.css" />
...
<body>
	<jsp:include page="${contextPath}/header.jsp" flush="true"></jsp:include>
      ...
      <div class="sc2_contents">
        ...
        <!-- 콘텐츠 영역 -->
	      ...
	      <div class="category">
	        ...
	        <!--소분류-->
	        <h3 id="smalltitle" style="display: none">소분류</h3>
	...
	<jsp:include page="${contextPath}/footer.jsp" flush="true"></jsp:include>
