	                                                    ...
	                                                    <div class="dot">
		                                                    ...
		                                                    <div class="hidden_menu">
		                                                        ...
		                                                        <ul class="hidden_menu_bar">
		                                                            <li><a href="${contextPath}/group/manager/report.do?user_id=${user.user_id}">신고</a></li>
		                                                            <li><a href="${contextPath}/group/manager/mandate.do?user_id=${user.user_id}">위임</a></li>
		                                                            <li><a href="${contextPath}/group/manager/exile.do?user_id=${user.user_id}">추방</a></li>
		                                                        </ul>
